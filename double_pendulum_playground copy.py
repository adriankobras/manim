        ...
        for i in range(len(x1)-1):
            ...
            if i >= 30:
                for n in range(i,i-30,-1):
                    line1 = Line(x1[n]*RIGHT + y1[n]*UP , x1[n-1]*RIGHT + y1[n-1]*UP).set_stroke(BLUE,width=2).set_opacity(0.03*a)
                ...
                for n in range(i,0,-1):
                    line1 = Line(x1[n]*RIGHT + y1[n]*UP , x1[n-1]*RIGHT + y1[n-1]*UP).set_stroke(BLUE,width=2).set_opacity(0.05*a)
